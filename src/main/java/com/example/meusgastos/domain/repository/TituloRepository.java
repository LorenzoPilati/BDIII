...
public interface TituloRepository extends JpaRepository<Titulo, Long> {
    ...
    @Query(nativeQuery = true, value = "SELECT * FROM public.titulo WHERE data_vencimento BETWEEN " + 
    "TO_TIMESTAMP(:periodoInicial, 'YYY-MM-DD hh24:MI:SS') AND TO_TIMESTAMP(:periodoFinal, 'YYY-MM-DD hh24:MI:SS')")
